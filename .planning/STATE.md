...
last_updated: "2026-08-19T14:45:52.140Z"
progress:
  total_phases: 5
  completed_phases: 5
  total_plans: 17
...
- [Phase ?]: window.plausible typed as (window as any).plausible — TS strict mode has no Plausible type; avoids global.d.ts for a single third-party shim
...
| 260825-flj | Contactformulier van `mailto:` → Web3Forms: submissions mailen nu direct naar Milan@oio-impact.com (echte access key eab3a773… in config.ts), geen mail-app meer die opent. ContactForm.astro volgt het bewezen BookInterestForm-patroon (fetch POST JSON, honeypot botcheck, statische i18n success/error-copy, Plausible 'Contact: Submit'). Velden + a11y + gele pill-CTA behouden; geen autoresponder (alleen mail naar Milan). NL+EN via gedeelde component — gebouwd (0 errors, 16 pagina's) | 2026-08-25 | 4fb1066 | [260825-flj-wire-contact-form-to-web3forms-so-submis](./quick/260825-flj-wire-contact-form-to-web3forms-so-submis/) |
| 260825-l6v | Milans eerste Substack-artikel ("De 'aftermath' van een faillissement") verschijnt nu op de site: "Recente artikelen"-sectie komt automatisch terug nu de feed inhoud heeft. Single-post layout toegevoegd (art__grid--single, max-width 640px, lege supporting-kolom niet meer gerenderd) zodat één artikel een nette featured kaart is i.p.v. halflege grid. Nevenwerk: screenshot.js BASE → '/' (root-deploy), ongebruikte copySubmit-var in ContactForm opgeruimd — gebouwd + screenshot gecontroleerd (0 errors, 16 pagina's) | 2026-08-25 | ed3cfd3 | [260825-l6v-toon-milans-eerste-substack-artikel-op-d](./quick/260825-l6v-toon-milans-eerste-substack-artikel-op-d/) |
...
**Last session:** 2026-08-19T14:45:52.129Z
